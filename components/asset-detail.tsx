    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-8 md:grid-cols-[2fr_1fr]">
        <div className="space-y-6">
          <div className="relative aspect-square w-full overflow-hidden rounded-lg border border-[#2A2A2A] shadow-lg">
          ...
          <Card className="bg-[#1C1C1C] border-[#2A2A2A]">
            <CardContent className="p-5">
              <div className="mb-3 flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" className="h-8 gap-1.5 hover:bg-[#2A2A2A]" onClick={handleCopyPrompt}>
